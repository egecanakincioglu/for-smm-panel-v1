...
if (isset($_SESSION['user'])) {
	...
	if (mysqli_num_rows($check_user) == 0) {
		...
		$post_balance = $cfg_member_bonus;
		$post_price = $cfg_member_price;
		if (isset($_POST['add'])) {
			...
			if (empty($post_username) || empty($post_password)) {
				...
				$msg_type = "error";
				$msg_content = "<b>Başarısız:</b> Bakiyeniz Üye olmak için yeterli değil.";
			} else {
				$post_api = random(20);
				...
				if ($insert_user == TRUE) {
					$msg_type = "success";
					$msg_content = "<b>Başarılı:</b> Üye eklendi.<br /><b>Kullanıcı adı:</b> $post_username<br /><b>Şifreler:</b> $post_password<br /><b>Seviyeler:</b> Üyeler<br /><b>Denge:</b> Rp ".number_format($post_balance,0,',','.');
				} else {
					$msg_type = "error";
							...
							<div class="col-md-12">
								<div class="panel panel-default">
									<div class="panel-heading">
										<h3 class="panel-title"><i class="fa fa-plus"></i> Üye ekle</h3>
									</div>
									<div class="panel-body">
										...
										<form class="form-horizontal" role="form" method="POST">
											<div class="alert alert-info">
												- Bakiyenizden IDR düşüldü <?php echo number_format($post_price,0,',','.'); ?> 1 Üyenin kaydı için.<br />
												- Yeni üyelere Rp bakiyesi verilecek. <?php echo number_format($post_balance,0,',','.'); ?>.
											</div>
