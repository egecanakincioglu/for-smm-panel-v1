...
if (isset($_SESSION['user'])) {
	...
	if (mysqli_num_rows($check_user) == 0) {
		...
		$post_balance = $cfg_admin_bonus;
		$post_price = $cfg_admin_price;
		if (isset($_POST['add'])) {
			...
			if (empty($post_username) || empty($post_password)) {
				...
				$msg_type = "error";
				$msg_content = "<b>Başarısız:</b> Bakiyeniz Admin'e kaydolmak için yeterli değil.";
			} else {
				$post_api = random(20);
				...
				if ($insert_user == TRUE) {
					$msg_type = "success";
					$msg_content = "<b>Başarılı:</b> Yönetici eklendi.<br /><b>Kullanıcı adı:</b> $post_username<br /><b>Şifreler:</b> $post_password<br /><b>Seviyeler:</b> Yönetici<br /><b>Denge:</b> Rp ".number_format($post_balance,0,',','.');
				} else {
					$msg_type = "error";
							...
							<div class="col-md-12">
								<div class="panel panel-default">
									<div class="panel-heading">
										<h3 class="panel-title"><i class="fa fa-plus"></i> Yönetici Ekle</h3>
									</div>
									<div class="panel-body">
										...
										<form class="form-horizontal" role="form" method="POST">
											<div class="alert alert-info">
												- Bakiyenizden IDR düşüldü <?php echo number_format($post_price,0,',','.'); ?> kayıt için 1 Yönetici.<br />
												- Yeni yönetici Rp'lik bir bakiye alacak. <?php echo number_format($post_balance,0,',','.'); ?>.
											</div>
